...
15:56 2023/3/8
成功使用vscode 在ssh远程使用 jupyter ，就不需要开网页了。那个不方便。


16:40 2023/3/8
我现在能证明我显卡是通用的，但不能证明我机器 是能用的。
一个j1800双核。现在代码一直各种报错。

我感觉不应该太省钱不应该让显卡以外的零件成为瓶颈，不然显卡不是白买了吗？
...
我们一定要用流行的工具。用适配的工具，比如同时代的。
新的工具贵，那就选上世代的，而每个零件都选同世代的。
...
主板供电不重要，那是给cpu超频的。其实gpu超频也不重要，所以买残血供电的gpu也能接受，但价格要合理。

ddr4 内存3200，3600好像有bug，3200以下都可以。
16x4吧，32g内存不好出手，能插4条就4条吧。
